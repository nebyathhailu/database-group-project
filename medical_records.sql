...
('R2','021', '2024-01-15', 16.0, 102.3, 'severe malnutrition'),
('R3','022', '2024-05-20', 12.8, 95.0, 'mild malnutrition'),
('R4','024', '2024-06-10', 14.5, 98.2, 'moderate malnutrition'),
('R5','025', '2024-07-15', 16.0, 102.3, 'severe malnutrition'),
...
('R12','031', '2024-8-15', 16.0, 102.3, 'severe malnutrition'),
('R13','032', '2024-9-20', 12.8, 95.0, 'mild malnutrition'),
('R14','033', '2024-10-10', 14.5, 98.2, 'moderate malnutrition'),
('R15','034', '2024-04-15', 16.0, 102.3, 'severe malnutrition');
